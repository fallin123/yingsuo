...
import com.donkingliang.imageselector.PreviewDeleteActivity;
...
public class ImageSelectorUtils {
     ...
     * @param
     */
    public static void openPhotoDelete(Activity activity, ArrayList<String> images, int position) {
        PreviewDeleteActivity.openActivity(activity, images, position);
    }
}
