...
public class SealConst {
    ...
    public static final String SEALTALK_LOGING_YINGSUONUM = "loginyingsuonum";
    public static final String SEALTALK_LOGING_SEX = "loginsex";
    public static final String SEALTALK_LOGING_ADRESS = "loginadress";
    public static final String SEALTALK_LOGING_SLOGON = "loginslogon";
