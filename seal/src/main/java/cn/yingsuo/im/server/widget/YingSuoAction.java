...
import cn.yingsuo.im.server.BaseAction;
...
import cn.yingsuo.im.server.request.AgreeFriendsRequest;
...
import cn.yingsuo.im.server.request.FriendInvitationRequest;
import cn.yingsuo.im.server.request.JoinGroupRequest;
import cn.yingsuo.im.server.request.LoginRequest;
import cn.yingsuo.im.server.request.QuitGroupRequest;
import cn.yingsuo.im.server.request.RegisterRequest;
import cn.yingsuo.im.server.request.RemoveFromBlacklistRequest;
import cn.yingsuo.im.server.request.RestPasswordRequest;
import cn.yingsuo.im.server.request.SendCodeRequest;
...
import cn.yingsuo.im.server.request.SetNameRequest;
import cn.yingsuo.im.server.request.SetPortraitRequest;
...
public class YingSuoAction extends BaseAction {
     ...
     * @param context 上下文
     */
    public YingSuoAction(Context context) {
        super(context);
    }
    ...
    public SendCodeResponse sendCode(String region, String phone) throws HttpException {
        ...
        String json = JsonMananger.beanToJson(new SendCodeRequest(phone,""));
        StringEntity entity = null;
        try {
            entity = new StringEntity(json, ENCODING);
            entity.setContentType(CONTENT_TYPE);
