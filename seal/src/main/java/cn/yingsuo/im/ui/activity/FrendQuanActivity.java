...
public class FrendQuanActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frend_quan);
        initView();
    ...
    private void initView() {
        ...
        photoUtils = new PhotoUtils(new PhotoUtils.OnPhotoResultListener() {
            ...
            public void onPhotoResult(Uri uri) {
                ...
                Intent intent = new Intent(FrendQuanActivity.this, FrendQuanSendActivity.class);
    ...
    private void initListView() {
        ...
        //实现自动下拉刷新功能
        frendQuanListView.getSwipeToRefresh().post(new Runnable() {
            @Override
            public void run() {
                frendQuanListView.setRefreshing(true);//执行下拉刷新的动画
        ...
        frendQuanListView.setRefreshListener(refreshListener);
        frendQuanListView.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    Glide.with(FrendQuanActivity.this).resumeRequests();
                } else {
                    Glide.with(FrendQuanActivity.this).pauseRequests();
                }
        ...
        frendCommentBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (null == pingContent || "".equals(pingContent)) {
                    NToast.longToast(FrendQuanActivity.this, "内容不能为空");
                    return;
                }
                LoadDialog.show(mContext);
    ...
    public Object doInBackground(int requestCode, String id) throws HttpException {
        switch (requestCode) {
            case GET_FREND_LIST:
                return action.getFrendQuanList();
    ...
    public void onSuccess(int requestCode, Object result) {
        if (null != result) {
            switch (requestCode) {
                case GET_FREND_LIST:
                    LoadDialog.dismiss(FrendQuanActivity.this);
                    ...
                    if (frendQuanListResponse.getCode() == 1) {
                        ...
                        NToast.longToast(FrendQuanActivity.this, frendQuanListResponse.getMsg());
                    }
                    frendQuanListView.setRefreshing(false);
                    break;
                case REQUEST_CLICK_ZAN:
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case PhotoUtils.INTENT_TAKE://拍照成功返回
                photoUtils.onActivityResultForCamera(FrendQuanActivity.this, requestCode);
                break;
        }
    ...
    private void showPhotoDialog() {
        ...
        dialog.setConfirmListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                photoUtils.takePicture(FrendQuanActivity.this);
            }
        });
        dialog.setMiddleListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                photoUtils.selectAllPicture(FrendQuanActivity.this, 9);
            }
        });
        dialog.show();
    }
