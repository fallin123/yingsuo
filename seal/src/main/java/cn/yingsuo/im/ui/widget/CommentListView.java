...
import cn.yingsuo.im.model.FrendCommentEntity;
...
public class CommentListView extends LinearLayout {
    ...
    private List<FrendCommentEntity> mDatas;
    ...
    public void setDatas(List<FrendCommentEntity> datas){
        if(datas == null ){
            datas = new ArrayList<FrendCommentEntity>();
        }
        mDatas = datas;
        notifyDataSetChanged();
    }

    public List<FrendCommentEntity> getDatas(){
        return mDatas;
    }
    ...
    private View getView(final int position){
        ...
        View convertView = layoutInflater.inflate(R.layout.frend_quan_item_comment, null, false);

        TextView commentTv = (TextView) convertView.findViewById(R.id.commentTv);
        final CircleMovementMethod circleMovementMethod = new CircleMovementMethod(itemSelectorColor, itemSelectorColor);

        final FrendCommentEntity bean = mDatas.get(position);
        String name = bean.getUser().getNi_name();
        String id = bean.getId();
        String toReplyName = "";
        if (bean.getToReplyUser() != null) {
            toReplyName = bean.getToReplyUser().getNi_name();
        }
